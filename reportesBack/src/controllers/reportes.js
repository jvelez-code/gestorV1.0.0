...
const postSecretariaVirtual = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
...
const postTmoEntranteSaliente = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postLlamadasRecibidas = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postCalificacionServicio = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postReporteTmoSaliente = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postDevolucionFiltrada = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postReporteTmoDetallado = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postReporteTmo = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const postPorcentajeTipificacion = async (req, res) =>{
    try {
        //parametro de header
        //alt +96 `
        let fechaini=req.body.fechaini
...
const getReportesid = async (req, res, next) => {
    ...
    const potsMonitoreo = async (req, res) =>{
        try {
...
//Consulta de parametros;
    ...
    const postUsuariosXempresa = async (req, res) =>{
        try {   
